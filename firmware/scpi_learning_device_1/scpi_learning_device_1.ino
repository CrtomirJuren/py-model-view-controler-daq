...
Example : https://magna-power.com/assets/docs/html_ts/index-scpi.html
...
Commands:
  ...
  *RST = *CLS
  ...
  SYSTem:LED:BRIGhtness <value>
    ...
    Example: SYSTem:LED:BRIGhtness 8

  SYSTem:LED:BRIGhtness?
    Queries the current LED's brightness value
    Example: SYSTem:LED:BRIGhtness?
    Example: SYST:LED:BRIG?
  ...
  :DIGITAL:SWITCH# ON|OFF
    turn a switch on or off. 1 based
    Example: :DIGI:SWIT1 ON

  # not implemented
  :DIGITAL:SWITCH#?
    get a switch' status. 1 based
    Example: :DIGITAL:SWITCH1?  --> response --> OFF
